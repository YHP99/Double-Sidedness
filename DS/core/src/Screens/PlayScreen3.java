...
import Sprite.GM3;
import Tools.B2WorldCreator3;
import Tools.WorldContactListener3;
...
public class PlayScreen3 implements Screen {
	...
	private WorldContactListener3 world_contact;
	private World world;
	...
	public PlayScreen3(MyGdxGame game, boolean is_first) {
		// 사운드 관련 소스코드
		MusicPlayer.BackMusicStop();
		MusicPlayer.MainBackgMusic("Music/Stage3.mp3");
		...
		world_contact = new WorldContactListener3();
	...
	public void update(float dt) {
		...
		for (Enemy3 enemy : creator.getGoombas())
			enemy.update(dt);
