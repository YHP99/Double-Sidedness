...
public class GM extends Sprite{
	...
	public void defineGM() {
		bdef = new BodyDef();
		bdef.position.set(280 / game.PPM, 40 / game.PPM);		// 280, 40
		...
		fdef.filter.maskBits = (short) (game.ENEMY_BIT | game.OBJECT_BIT
				| game.DEAD_BIT | game.DEAD2_BIT
				| game.DIALOG2_BIT | game.DIALOG3_BIT | game.DIALOG4_BIT | game.DIALOG5_BIT);
		fdef.shape = shape;
