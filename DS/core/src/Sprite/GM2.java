...
public class GM2 extends Sprite{
	...
	public void defineGM() {
		bdef = new BodyDef();
		bdef.position.set(4930 / game.PPM, 40 / game.PPM);		// 4930, 40
		...
		fdef.filter.maskBits = (short) (game.ENEMY_BIT | game.OBJECT_BIT
				| game.DEAD2_BIT | game.DEAD3_BIT
				| game.DIALOG7_BIT | game.DIALOG8_BIT);
		fdef.shape = shape;
