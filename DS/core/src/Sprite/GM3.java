...
public class GM3 extends Sprite{
	...
	public void defineGM() {
		bdef = new BodyDef();
		bdef.position.set(9935 / game.PPM, 40 / game.PPM);		// 9935, 40
		...
		fdef.filter.maskBits = (short) (game.ENEMY_BIT | game.OBJECT_BIT
				| game.DEAD3_BIT | game.DEAD4_BIT
				| game.DIALOG10_BIT | game.DIALOG11_BIT);
		fdef.shape = shape;
